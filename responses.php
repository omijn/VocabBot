<?php
  ...
  */
  ...
  $responses = array(
    ...
    'exclamation' => array("!"),
    'smileys' => array(":)", ""),
    'ty_responses' => array("No problem!", "You're welcome!"),
    'bye_responses' => array("Bye!", "See you later!", "Goodbye!"),
    ...
    'helpmsg' => "Hi! I'm a vocabulary learning assistant. If you want me to define a word, you can ask me things like '\x0313define <word>\x03', '\x0313What's a <word>?\x03' or simply '\x0313<word>?\x03' (your word followed by a question mark), etc. If you want me to show you some new words, you can ask me things like '\x0313show me some random words\x03' or '\x0313send me a new word\x03'. Feel free to talk to me in natural English. You can say hi, bye, thanks or ask me what's up!"
  );

  $responses_file = fopen("bot_responses.txt", "w");
